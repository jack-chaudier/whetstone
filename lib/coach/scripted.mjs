const invitationTemplates = {
  make: [
    ...
    (c, last, minutes) => ({ action: `Write one concrete beat, then leave the polish alone. The near horizon: ${milestoneClause(c)}.`, stopCondition: 'Stop after the first consequential decision.', continuity: last, scopeMinutes: minutes }),
